...
//	@Autowired
//	private IPositionRepository2 repo2;
...
//	@GetMapping("/position2/{Id}")
//	public Position getById(@PathVariable String Id) {
//		Position position=repo2.FindById(Position.class, Id);
//		return position;
//	}
	@GetMapping("/id/{Id}")
...
//	@PostMapping(value ="/position2/post", produces="application/json")
//	public int Add(@RequestBody Position position) {
//		int a=repo2.Insert(position);
//		return a;
//	}
